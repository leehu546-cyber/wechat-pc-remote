...
Write-Host "[1/5] Power settings..." -ForegroundColor Yellow
...
Write-Host "[2/5] Network adapter power saving..." -ForegroundColor Yellow
...
Write-Host "[3/5] Auto-start WeClaw on login..." -ForegroundColor Yellow
...
Write-Host "[4/5] WeClaw + OpenCode config..." -ForegroundColor Yellow
